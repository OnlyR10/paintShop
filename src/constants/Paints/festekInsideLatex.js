...
export const insideLatex = {
  ...
  documentation: {
    description: {
      ...
      note: {
        value:
          "Показатель значение укрывистости для краски , колерованной на базе TR в желтые, оранжевые, красные цвета, могут достигаться до 240 г/м2.",
        label: "Примечание",
      },

      package: { value: "10 л; 20 л.", label: "Упаковка" },
    },
