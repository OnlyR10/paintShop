...
export const relief = {
  ...
  documentation: {
    description: {
      ...
      technicalData: [
        { qualityIndicators: "Массовая доля нелетучих веществ, %", value: "74-82" },
        { qualityIndicators: "Показатель концентрации ионов водорода, рН", value: "7,0-9,5" },
        {
          qualityIndicators:
        ...
        { qualityIndicators: "Адгезия покрытия к основанию, Мпа, (по ГОСТ 28574 п.5) не менее", value: "0,8" },
        {
          qualityIndicators:
        ...
        { qualityIndicators: "- «Гексадекон», «Дескоцид», «Полидез»", value: "30" },
        {
        ...
        { qualityIndicators: "Коэффициент паропроницаемости, мг/(м∙ч∙Па), не менее", value: "0,015" },
        { qualityIndicators: "Морозостойкость покрытия, циклы, не менее", value: "50" },
        {
          qualityIndicators: "Устойчивость к воздействию переменных температур, циклы, (по ГОСТ 27037) не менее",
          value: "10",
        },
        {
        ...
        { qualityIndicators: "Срок службы покрытия в условиях эксплуатации ХЛ1, УХЛ1, лет, не менее", value: "6" },
      ],
      ...
      package: "Пластиковые ведра: 11л,20л",
    },
