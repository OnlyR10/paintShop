...
export const grunt = {
  ...
  documentation: {
    description: {
      ...
      composition: {
        value: "Водная дисперсия акрилового сополимера с добавлением функциональных добавок.",
        label: "Состав",
      },
    ...
    applicationTechnology: {
      ...
      consumption: {
        value: "0,05-0,25 кг/м2 в зависимости от впитывающей способности основания",
        label: "Расход",
      },
    },
    ...
    additionalInformation: {
      ...
      warrantyPeriod: {
        value: "Срок хранения 12 месяцев с даты изготовления, указанной на упаковке.",
